...
public class hHardQ1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hhard_q1);

        question = findViewById(R.id.hHardCurrentQ);
        QCount = findViewById(R.id.hHard_qCount);
        timer = findViewById(R.id.hHardTimer);

        option1 = findViewById(R.id.hHard1_OptionA);
        option2 = findViewById(R.id.hHard1_OptionB);
        option3 = findViewById(R.id.hHard1_OptionC);
        option4 = findViewById(R.id.hHard1_OptionD);
    ...
    private void getHistEasyQuestions() {
        ...
        questionList.add(new hEasyQ1_List("ha", "A. Apolinario Mabini", "B. Emilio Jacinto", "C. Andres Bonifacio", "D. Jose Rizal", 3));
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.hHard1_OptionA:
                selectedOption = 1;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.hHard1_OptionB:
                selectedOption = 2;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.hHard1_OptionC:
                selectedOption = 3;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.hHard1_OptionD:
                selectedOption =4;
                break;
            default:
        }
    ...
    private void changeQuestion(){
        if(qNum < questionList.size() - 1){
            ...
            Intent intent = new Intent(hHardQ1.this, hScoreActivity.class);
