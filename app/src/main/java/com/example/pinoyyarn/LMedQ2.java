...
public class LMedQ2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lmed_q2);

        question = findViewById(R.id.LMedCurrentQ);
        QCount = findViewById(R.id.LMed_qCount);
        timer = findViewById(R.id.LMedTimer);

        option1 = findViewById(R.id.LMed2_OptionA);
        option2 = findViewById(R.id.LMed2_OptionB);
        option3 = findViewById(R.id.LMed2_OptionC);
        option4 = findViewById(R.id.LMed2_OptionD);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.LMed2_OptionA:
                selectedOption = 1;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.LMed2_OptionB:
                selectedOption = 2;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.LMed2_OptionC:
                selectedOption = 3;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.LMed2_OptionD:
                selectedOption =4;
                break;
            default:
        }
