...
public class LMedQ4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lmed_q4);

        question = findViewById(R.id.LMedCurrentQ);
        QCount = findViewById(R.id.LMed_qCount);
        timer = findViewById(R.id.LMedTimer);

        option1 = findViewById(R.id.LMed4_OptionA);
        option2 = findViewById(R.id.LMed4_OptionB);
        option3 = findViewById(R.id.LMed4_OptionC);
        option4 = findViewById(R.id.LMed4_OptionD);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.LMed4_OptionA:
                selectedOption = 1;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.LMed4_OptionB:
                selectedOption = 2;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.LMed4_OptionC:
                selectedOption = 3;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.LMed4_OptionD:
                selectedOption =4;
                break;
            default:
        }
    ...
    private void changeQuestion(){
        if(qNum < questionList.size() - 1){
            ...
            Intent intent = new Intent(LMedQ4.this, hScoreActivity.class);
