...
public class LMedQ1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lmed_q1);

        question = findViewById(R.id.LMedCurrentQ);
        QCount = findViewById(R.id.LMed_qCount);
        timer = findViewById(R.id.LMedTimer);

        option1 = findViewById(R.id.LMed1_OptionA);
        option2 = findViewById(R.id.LMed1_OptionB);
        option3 = findViewById(R.id.LMed1_OptionC);
        option4 = findViewById(R.id.LMed1_OptionD);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.LMed1_OptionA:
                selectedOption = 1;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.LMed1_OptionB:
                selectedOption = 2;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.LMed1_OptionC:
                selectedOption = 3;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.LMed1_OptionD:
                selectedOption =4;
                break;
            default:
        }
    ...
    private void changeQuestion(){
        if(qNum < questionList.size() - 1){
            ...
            Intent intent = new Intent(LMedQ1.this, hScoreActivity.class);
