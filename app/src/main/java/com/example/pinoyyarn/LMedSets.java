...
public class LMedSets extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hintone = (Button) findViewById(R.id.lmed1_hint);
        ...
        hinttwo = (Button) findViewById(R.id.lmed1_hint2);
        ...
        hintthree = (Button) findViewById(R.id.lmed1_hint3);
        ...
        hintfour = (Button) findViewById(R.id.lmed1_hint4);
