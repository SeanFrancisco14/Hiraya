...
public class cMedQ2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cmed_q2);

        question = findViewById(R.id.cMedCurrentQ);
        QCount = findViewById(R.id.cMed_qCount);
        timer = findViewById(R.id.cMedTimer);

        option1 = findViewById(R.id.cMed2_OptionA);
        option2 = findViewById(R.id.cMed2_OptionB);
        option3 = findViewById(R.id.cMed2_OptionC);
        option4 = findViewById(R.id.cMed2_OptionD);
    ...
    private void getCultEasyQuestions() {
        ...
        questionList.add(new cEasyQ1_List("Tanong mo sa pagong", "A", "B", "C", "D", 4));
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.cMed2_OptionA:
                selectedOption = 1;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.cMed2_OptionB:
                selectedOption = 2;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.cMed2_OptionC:
                selectedOption = 3;
                break;
            default:
        }
        switch(v.getId()){
            case R.id.cMed2_OptionD:
                selectedOption =4;
                break;
            default:
        }
    ...
    private void changeQuestion(){
        if(qNum < questionList.size() - 1){
            ...
            Intent intent = new Intent(cMedQ2.this, cScoreActivity.class);
